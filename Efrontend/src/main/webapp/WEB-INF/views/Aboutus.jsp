...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <div class="well">
                <h3 style="line-height:20%;"><i class="fa fa-home fa-1x" style="line-height:6%;color:#339966"></i> Address:Izmit
izmit</h3>               
                <p style="margin-top:6%;line-height:35%"></p>
                <br />
                <br />
                <h3 style="line-height:20%;"><i class="fa fa-envelope fa-1x" style="line-height:6%;color:#339966"></i> E-Mail Address:boutique15@gmail.com</h3>
                <p style="margin-top:6%;line-height:35%"></p>
                <br />
                <br />
                <h3 style="line-height:20%;"><i class="fa fa-user fa-1x" style="line-height:6%;color:#339966"></i> Contact Number:044 2534568</h3>
                <p style="margin-top:6%;line-height:35%"></p>
                <br />
                <br />
                <h3 style="line-height:20%;"><i class="fa fa-yelp fa-1x" style="line-height:6%;color:#339966"></i>Website: </h3>
                <p style="margin-top:6%;line-height:35%"><a href="home" role="btn btn-success">www.Boutique.com</a></p>
            </div>
        </div>
        <div class="col-sm-6">
